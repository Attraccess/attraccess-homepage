...
{name}`,
    ...
    "home.hero.title.line1": "Authorization that",
    "home.hero.title.line2": "reaches the machine.",
    "home.hero.subtitle":
      "Machine authorization for teaching and research workshops. Connect identity, machine-specific authorization, and machine interfaces with operational session records.",
    "home.hero.cta.primary": "Discuss a 90-day pilot",
    "home.hero.cta.secondary": "How it works",
    "home.hero.note": "For shared workshops, labs, and machine fleets",
    ...
    "home.cta.primary": "Open draft email",
    "home.loop.label": "The control loop",
    "home.loop.title": "Authorization is checked where use begins.",
    "home.loop.intro": "From identity through operations, Attraccess connects current machine authorization with traceable sessions.",
    "home.loop.step1.title": "Identify", "home.loop.step1.text": "Present a credential at the control point.",
    "home.loop.step2.title": "Evaluate", "home.loop.step2.text": "Check current, machine-specific authorization.",
    "home.loop.step3.title": "Apply", "home.loop.step3.text": "Send the result to the machine interface.",
    "home.loop.step4.title": "Record", "home.loop.step4.text": "Create a traceable operational session.",
    "home.loop.step5.title": "Operate", "home.loop.step5.text": "Use session data for supervision and maintenance workflows.",
    "home.loop.safety": "Attraccess is outside the safety-rated control chain and does not replace machine safeguarding.",
  },
  de: {
    // Navigation
    "nav.home": "Home",
...
{name}`,
    ...
    "home.hero.title.line1": "Berechtigung, die",
    "home.hero.title.line2": "die Maschine erreicht.",
    "home.hero.subtitle":
      "Maschinenberechtigung für Lehr- und Forschungswerkstätten. Verbinden Sie Identität, maschinenspezifische Berechtigungen und Schnittstellen mit betrieblichen Sitzungsprotokollen.",
    "home.hero.cta.primary": "90-Tage-Pilot besprechen",
    "home.hero.cta.secondary": "So funktioniert's",
    "home.hero.note": "Für geteilte Werkstätten, Labore und Maschinenflotten",
    ...
    "home.cta.primary": "E-Mail-Entwurf öffnen",
    "home.loop.label": "Der Kontrollkreislauf",
    "home.loop.title": "Berechtigung wird dort geprüft, wo Nutzung beginnt.",
    "home.loop.intro": "Von der Identität bis zum Betrieb verbindet Attraccess aktuelle Maschinenberechtigungen mit nachvollziehbaren Sitzungen.",
    "home.loop.step1.title": "Identifizieren", "home.loop.step1.text": "Ausweis am Kontrollpunkt vorhalten.",
    "home.loop.step2.title": "Bewerten", "home.loop.step2.text": "Aktuelle maschinenspezifische Berechtigung prüfen.",
    "home.loop.step3.title": "Anwenden", "home.loop.step3.text": "Ergebnis an die Maschinenschnittstelle senden.",
    "home.loop.step4.title": "Erfassen", "home.loop.step4.text": "Eine nachvollziehbare Betriebssitzung erstellen.",
    "home.loop.step5.title": "Betreiben", "home.loop.step5.text": "Sitzungsdaten für Aufsicht und Wartung nutzen.",
    "home.loop.safety": "Attraccess ist außerhalb der sicherheitsgerichteten Steuerung und ersetzt keine Maschinenschutzmaßnahmen.",
  },
  fr: {
    // Navigation
    "nav.home": "Accueil",
...
{name}`,
    ...
    "home.hero.title.line1": "Une autorisation qui",
    "home.hero.title.line2": "atteint la machine.",
    "home.hero.subtitle":
      "Autorisation machine pour les ateliers d'enseignement et de recherche. Reliez identité, autorisation par machine et interfaces machine avec des enregistrements de session opérationnels.",
    "home.hero.cta.primary": "Discuter d'un pilote de 90 jours",
    "home.hero.cta.secondary": "Comment ça marche",
    "home.hero.note": "Pour les ateliers, laboratoires et parcs de machines partagés",
    ...
    "home.cta.primary": "Ouvrir un brouillon d'e-mail",
    "home.loop.label": "La boucle de contrôle",
    "home.loop.title": "L'autorisation est vérifiée là où l'utilisation commence.",
    "home.loop.intro": "De l'identité à l'exploitation, Attraccess relie les autorisations machine actuelles à des sessions traçables.",
    "home.loop.step1.title": "Identifier", "home.loop.step1.text": "Présentez un identifiant au point de contrôle.",
    "home.loop.step2.title": "Évaluer", "home.loop.step2.text": "Vérifiez l'autorisation actuelle pour la machine.",
    "home.loop.step3.title": "Appliquer", "home.loop.step3.text": "Envoyez le résultat à l'interface machine.",
    "home.loop.step4.title": "Enregistrer", "home.loop.step4.text": "Créez une session opérationnelle traçable.",
    "home.loop.step5.title": "Exploiter", "home.loop.step5.text": "Utilisez les données de session pour la supervision et la maintenance.",
    "home.loop.safety": "Attraccess est hors de la chaîne de contrôle de sécurité et ne remplace pas les protections machine.",
  },
  nl: {
    // Navigation
    "nav.home": "Home",
...
{name}`,
    ...
    "home.hero.title.line1": "Autorisatie die",
    "home.hero.title.line2": "de machine bereikt.",
    "home.hero.subtitle":
      "Machineautorisatie voor onderwijs- en onderzoekswerkplaatsen. Verbind identiteit, machinespecifieke autorisatie en machine-interfaces met operationele sessieregistraties.",
    "home.hero.cta.primary": "Bespreek een pilot van 90 dagen",
    "home.hero.cta.secondary": "Zo werkt het",
    "home.hero.note": "Voor gedeelde werkplaatsen, labs en machineparken",
    ...
    "home.cta.primary": "E-mailconcept openen",
    "home.loop.label": "De controlelus",
    "home.loop.title": "Autorisatie wordt gecontroleerd waar gebruik begint.",
    "home.loop.intro": "Van identiteit tot bedrijfsvoering verbindt Attraccess actuele machineautorisatie met traceerbare sessies.",
    "home.loop.step1.title": "Identificeren", "home.loop.step1.text": "Bied een pas aan bij het controlepunt.",
    "home.loop.step2.title": "Beoordelen", "home.loop.step2.text": "Controleer actuele machinespecifieke autorisatie.",
    "home.loop.step3.title": "Toepassen", "home.loop.step3.text": "Stuur het resultaat naar de machine-interface.",
    "home.loop.step4.title": "Vastleggen", "home.loop.step4.text": "Maak een traceerbare operationele sessie.",
    "home.loop.step5.title": "Beheren", "home.loop.step5.text": "Gebruik sessiedata voor toezicht en onderhoud.",
    "home.loop.safety": "Attraccess valt buiten de veiligheidsgerichte regelketen en vervangt geen machinebeveiliging.",
  },
};
